...
namespace MiniShop.UI.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<User> userManager, RoleManager<Role> roleManager, SignInManager<User> signInManager, ICartService cartManager, IOrderService orderManager)
        {
        ...
        {
            #region Geçmiş Sipariş Bilgileri
            var userId = _userManager.GetUserId(User);
            var orders = await _orderManager.GetAllOrdersAsync(userId);
            #endregion
            return View(orders);
        }
