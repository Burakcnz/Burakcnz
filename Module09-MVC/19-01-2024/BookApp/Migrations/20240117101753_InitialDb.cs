    ...
    public partial class InitialDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2941), "Genel kategorisine giren ve kategorisiz kalan kitaplar", true, false, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2956), "Genel", "Genel" },
                    { 2, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2980), "Bilim Kurgu Kitapları", true, false, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2981), "Bilim Kurgu", "bilim-kurgu" },
                    { 3, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2982), "Bilim ve Mühendislik Kitapları", true, false, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2982), "Bilim ve Mühendislik", "bilim-ve-muhendislik" },
                    { 4, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2984), "Distopya Kitapları", true, false, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2984), "Distopya", "distopya" },
                    { 5, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2985), "Dünya Tarihi Kitapları", true, false, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2985), "Dünya Tarihi", "dunya-tarihi" },
                    { 6, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2986), "Edebiyat Kitapları", true, false, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2986), "Edebiyat", "edebiyat" },
                    { 7, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2987), "Fizik Kitapları", true, false, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2988), "Fizik", "fizik" },
                    { 8, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2988), "İnsan ve Toplum Kitapları", true, false, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2989), "İnsan ve Toplum", "insan-ve-toplum" },
                    { 9, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2990), "Kişisel Kitapları", true, false, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2990), "Kişisel Gelişim", "kisisel-gelisim" },
                    { 10, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2991), "Popüler Bilim Kitapları", true, false, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2991), "Popüler Bilim", "populer-bilim" },
                    { 11, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2992), "Romanlar", true, false, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2992), "Roman", "roman" },
                    { 12, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2994), "Rus Edebiyatı Kitapları", true, false, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2994), "Rus Edebiyatı", "rus-edebiyati" },
                    { 13, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2996), "Söyleşi Kitapları", true, false, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2996), "Söyleşi", "soylesi" },
                    { 14, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2997), "Tarih Kitapları", true, false, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2997), "Tarih", "tarih" },
                    { 15, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2998), "Türkiye Tarihi Kitapları", true, false, new DateTime(2024, 1, 17, 13, 17, 53, 893, DateTimeKind.Local).AddTicks(2998), "Türkiye Tarihi", "turkiye-tarihi" }
                });
        }
