    ...
    public partial class InitialDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3444), "Genel kategorisine giren ve kategorisiz kalan kitaplar", true, false, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3458), "Genel", "Genel" },
                    { 2, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3464), "Bilim Kurgu Kitapları", true, false, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3465), "Bilim Kurgu", "bilim-kurgu" },
                    { 3, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3466), "Bilim ve Mühendislik Kitapları", true, false, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3467), "Bilim ve Mühendislik", "bilim-ve-muhendislik" },
                    { 4, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3468), "Distopya Kitapları", true, false, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3468), "Distopya", "distopya" },
                    { 5, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3470), "Dünya Tarihi Kitapları", true, false, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3470), "Dünya Tarihi", "dunya-tarihi" },
                    { 6, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3471), "Edebiyat Kitapları", true, false, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3472), "Edebiyat", "edebiyat" },
                    { 7, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3473), "Fizik Kitapları", true, false, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3473), "Fizik", "fizik" },
                    { 8, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3475), "İnsan ve Toplum Kitapları", true, false, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3475), "İnsan ve Toplum", "insan-ve-toplum" },
                    { 9, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3476), "Kişisel Kitapları", true, false, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3476), "Kişisel Gelişim", "kisisel-gelisim" },
                    { 10, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3478), "Popüler Bilim Kitapları", true, false, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3478), "Popüler Bilim", "populer-bilim" },
                    { 11, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3479), "Romanlar", true, false, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3480), "Roman", "roman" },
                    { 12, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3481), "Rus Edebiyatı Kitapları", true, false, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3481), "Rus Edebiyatı", "rus-edebiyati" },
                    { 13, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3482), "Söyleşi Kitapları", true, false, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3483), "Söyleşi", "soylesi" },
                    { 14, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3484), "Tarih Kitapları", true, false, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3484), "Tarih", "tarih" },
                    { 15, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3486), "Türkiye Tarihi Kitapları", true, false, new DateTime(2024, 1, 22, 13, 7, 49, 690, DateTimeKind.Local).AddTicks(3486), "Türkiye Tarihi", "turkiye-tarihi" }
                });
        }
